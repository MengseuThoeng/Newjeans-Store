            ...
            <div className="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              ...
              <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
                ...
                <p className="text-base text-gray-600">
                  Our Shipping Policy outlines the terms and conditions
                  regarding the shipping of products purchased from our website.
              ...
              <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
                ...
                <p className="text-base text-gray-600">
                  ...
                  period for a refund or exchange. Please refer to this policy
                  for details on eligibility and procedures.
                </p>
              </div>
              ...
              <div className="bg-gray-100 p-6 rounded-lg shadow-lg">
                ...
                <p className="text-base text-gray-600">
                  ...
                  products and services offered. It&apos;s important to review
                  and understand these terms before engaging with our platform.
                </p>
              </div>
            </div>
          </div>
